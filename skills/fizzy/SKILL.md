...
- **PR links:** Always post a comment on the Fizzy card when a PR is created or merged, with the PR URL. Example:
  ```bash
  fizzy comment create --card CARD_NUMBER --body "<p>PR: <a href=\"https://github.com/...\">https://github.com/...</a></p>"
  ```
